#!/usr/bin/env python3
"""
Single-Channel Audit Runner: Matrix eBasket Pre ML G01
Market: eBasket Money Line (ebasket_money_line)
"""
...
CHANNEL_KEY = "ebasket_money_line"
REPORT_OUTPUT_MD = "audit_report_ebasket_money_line.md"
