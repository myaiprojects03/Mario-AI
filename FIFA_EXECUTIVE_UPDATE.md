...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| FIFA Goals O/U | 150 tips/day | 0 tips | 0 tips | N/A (Pending) | +0.00 U | +0.0% |
...
Note: All figures represent authentic verified settlements from the official ledger. Zero simulated or blended figures.
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| FIFA Goals O/U | +0.00 U | 320 tips (~40/day) | -4.80 U (-4.80 U) | +16.00 U (+16.00 U) | +30.40 U (+30.40 U) |
...
The automated reporting engine is verified and operating under strict dual-report protocol:

- Noon Report (12:00 BRT - Interim / Partial):
  - Confirmed to display interim Daily Dispatched Tips, Settled Tips, Pending Tips, Daily Win Rate, Daily ROI, and Daily Net Units for the first half of the day.
  - Does not prematurely finalize unsettled in-play fixtures.

- Midnight Report (00:00 BRT - Final & MTD):
  - Confirmed to display Final Completed Daily Net Units for the completed calendar day.
  - Exclusively displays cumulative Month-to-Date (MTD) Net Units, MTD Win Rate, and MTD ROI.
  - Strict Cap Enforcement: Clamps 'Tips Dispatched Today' to exactly <= 150 (Goals), <= 150 (Money Line), and <= 100 (Asian Handicap).
  - Date Isolation: Dispatches are permanently tagged to publication date in BRT; previous-day matches can never slip into the next day's report.
  - 00:00 BRT Reset: Daily counters and limits reset strictly at 00:00 Brazil Time (BRT / UTC-3).

--------------------------------------------------------------------------------
Report compiled by Mario AI Executive Analytics Engine.