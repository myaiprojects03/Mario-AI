...
def get_channel_config() -> Tuple[Dict[str, str], Dict[str, str], str]:
    ...
    channel_map = {
        "fifa_goals_ou": os.getenv("TELEGRAM_CHANNEL_ID_FIFA_GOALS_OU") or os.getenv("TELEGRAM_CHANNEL_FIFA_GOALS") or default_channel,
        "fifa_asian_handicap": os.getenv("TELEGRAM_CHANNEL_ID_FIFA_ASIAN_HANDICAP") or os.getenv("TELEGRAM_CHANNEL_FIFA_AH") or default_channel,
        "fifa_money_line": os.getenv("TELEGRAM_CHANNEL_ID_FIFA_MONEY_LINE") or os.getenv("TELEGRAM_CHANNEL_FIFA_ML") or default_channel,
        "ebasket_money_line": os.getenv("TELEGRAM_CHANNEL_ID_EBASKET_MONEY_LINE") or os.getenv("TELEGRAM_CHANNEL_EBASKET_ML") or default_channel,
        "ebasket_ou": os.getenv("TELEGRAM_CHANNEL_ID_EBASKET_OU") or os.getenv("TELEGRAM_CHANNEL_ID_EBASKET_POINTS") or os.getenv("TELEGRAM_CHANNEL_EBASKET_POINTS") or default_channel,
    }
